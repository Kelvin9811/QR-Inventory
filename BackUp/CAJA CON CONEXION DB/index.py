...
class Product:
    ...
    def __init__(self, window):
       ...
       # Button Scan CodeQR
        ttk.Button(frame, text='Scan QR Code', command=self.scan_qr).grid(
    ...
    def sell_product(self):
        ...
        # Code Input
        Label(sell_frame, text='Código: ').grid(row=1, column=0)
        ...
        self.sell_tree.heading('#0', text='Código', anchor=CENTER)
